...
namespace Independent_Reader_GUI.Models.Hardware.LED
{
    ...
    internal class LEDsData
    {
        ...
        public string ValueBrightField { get; set; } = "?";
        ...
        public DataGridViewComboBoxCell UseBrightFieldComboBoxCell = new DataGridViewComboBoxCell();
        ...
        public DataGridViewComboBoxCell IOBrightFieldComboBoxCell = new DataGridViewComboBoxCell();
        ...
        public LEDsData()
        {
            UseBrightFieldComboBoxCell.Items.AddRange(useOptions);
            ...
            UseBrightFieldComboBoxCell.Value = UseCy5ComboBoxCell.Items[0];
            ...
            IOBrightFieldComboBoxCell.Items.AddRange(ioOptions);
            ...
            // FIXME: Use configuration as a parameter and set the user based defaults for these options
            IOBrightFieldComboBoxCell.Value = IOCy5ComboBoxCell.Items[0];
